...
const Hero = () => {
    return (
        <div className="bg-[url(/assets/bg.svg)] bg-cover bg-center h-[80vh] lg:h-[70vh]">
                ...
                <div className='flex flex-col gap-12 lg:flex-row justify-between items-center py-10 lg:py-16'>
                    ...
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className='w-full lg:w-[800px] space-y-5'>
                        <h2 className='text-white text-3xl md:text-5xl font-bold leading-tight'>
                            ...
                            <motion.span initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }} className='bg-linear-to-r from-white via-yellow-400 to-amber-600 bg-clip-text text-transparent'>
                                Boost Your Grades
                            </motion.span>
                        </h2>
